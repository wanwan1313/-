$(function () {
    ...
    // 選單按鈕變色
        if (userScrollTop >= ($('#about').offset().top - 100)) {
            $('.toggle').addClass('togglered')
            $('.toggle span').addClass('linewhite')
        }
        else {
            $('.toggle').removeClass('togglered')
            $('.toggle span').removeClass('linewhite')
        }
